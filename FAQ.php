...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>Questions et réponses|  KISTAMOS Group</title>
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown @@home">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item @@home1" href="index.php">Homepage</a></li>
            <li><a class="dropdown-item" href="homepage-2.php">Homepage 2</a></li>
            <li><a class="dropdown-item @@home3" href="homepage-3.php">Homepage 3</a></li>
            ...
            <li class="dropdown dropdown-submenu dropright">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdown0301">
                <li><a class="dropdown-item" href="index.php">Submenu 11</a></li>
                <li><a class="dropdown-item" href="index.php">Submenu 12</a></li>
              </ul>
            </li>
          </ul>
        </li>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 m-auto">
				...
				<!-- Page Description -->
Vous trouverez ici des réponses à toutes les questions fréquemment posées sur notre entreprise.<br> Si vous ne trouvez pas de réponse précise, <a
							href="contact.php">Contactez-nous.</a>		</div>
	</div>
</section>
